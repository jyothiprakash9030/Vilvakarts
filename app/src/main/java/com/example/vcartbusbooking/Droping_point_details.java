...
public class Droping_point_details extends AppCompatActivity {
    private RadioGroup radioGroup;
    private OkHttpClient client;
    private String selectedBpId;
    private static final String TAG = "Droping_point_details";
    ...
    TextView droppingDetails, amount, bus_name, Drop_point_from, Drop_point_to, Drop_point_Date;
    Button proceed_button_passenger;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Drop_point_from=findViewById(R.id.Drop_point_from);
        Drop_point_to=findViewById(R.id.Drop_point_to);
        Drop_point_Date=findViewById(R.id.Drop_point_Date);
        ...
        Drop_point_from.setText(from);
        Drop_point_to.setText(to);
        Drop_point_Date.setText(date);
        ...
        proceed_button.setOnClickListener(view -> {
            ...
            if (selectedBpId == null || selectedBpId.trim().isEmpty()) {
                ...
                toast = Toast.makeText(Droping_point_details.this, "Please select a boarding point", Toast.LENGTH_SHORT);
                toast.show();
            } else {
                Log.d("DEBUG", "Boarding point selected, proceeding to next activity");
                Intent intent = new Intent(Droping_point_details.this, Passenger_details.class);
    ...
    private void fetchBoardingTimes() {
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                runOnUiThread(() -> Toast.makeText(Droping_point_details.this,
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                if (response.isSuccessful()) {
                    try {
                        ...
                        if (data.has("droppingTimes")) {
                            Object droppingTimesObj = data.get("droppingTimes");
                            ...
                            if (droppingTimesArray.length() == 0) {
                                runOnUiThread(() -> {
                                    Toast.makeText(Droping_point_details.this, "No boarding points available", Toast.LENGTH_LONG).show();
        ...
        try {
            ...
            radioGroup.setOnCheckedChangeListener((group, checkedId) -> {
                if (checkedId != -1) {
                    ...
                    Log.d("BOARDING_POINTs", "Selected bpId: " + selectedBpId);
                    TripDataHolder dataHolder = TripDataHolder.getInstance();
                    dataHolder.setDpId(Integer.parseInt(selectedBpId));
